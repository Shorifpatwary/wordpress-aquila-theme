...
$header_menu_id =  $menu_class->get_menu_id('Aquila_Header_Menu');
...
<!-- wp_nav_menu([
    ...
    'container_class' => 'Header-Menu_Container_class'
]);

<h2> Footer Menu </h2>

wp_nav_menu([
    'theme_location' => 'Aquila_Footer_Menu',
    'container_class' => 'container__class'
]) -->