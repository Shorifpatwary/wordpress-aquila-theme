...
const plugins = (argv) => [
	...
	// copy plugin for copy file without including
	new CopyPlugin({
		patterns: [
...
const rules = [
	...
	// },
	{
		test: /\.(gif|png|jpeg|jpg|svg|woff|woff2|eot|ttf)$/i,
		use: [
			{
				loader: "url-loader",
				options: {
					limit: 40000, // if less than 40 kb, add base64 encoded image to css
					name: "[path][name][hash].[ext]", // if more than 40 kb move to this folder in build using file-loader
				},
			},
		],
	},
