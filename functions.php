...
if (! defined('AQUILA_BUILD_LIB_DIR_PATH')) {
    define('AQUILA_BUILD_LIB_DIR_PATH', untrailingslashit(get_template_directory()) . '/assets/build/library');
}
/**
 * set posts per page number for archive page .
 */
if (! defined('AQUILA_ARCHIVE_POST_PER_PAGE')) {
    define('AQUILA_ARCHIVE_POST_PER_PAGE', 5);
}
...
// include autoloader for theme classes file .
require_once AQUILA_DIR_PATH . '/inc/helpers/autoloader.php';
// include theme function
